...
var _class = function (_Base) {
  ...
  _class.prototype.saveorupdateAction = function () {
    var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
      var taskEntity, id, affectedRows, insertId;
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              taskEntity = this.post();
              id = taskEntity.id;
              ...
              _context.next = 6;
              return this.model('task').where({ id: id }).update(taskEntity);
            ...
            case 10:
              _context.next = 12;
              return this.model('task').add(taskEntity);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return this.model('task').where({ id: this.get('id') }).find();
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return this.model('task').where({ id: this.post('id') }).delete();
